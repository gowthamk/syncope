...
sig
  ...
  val Z3_goal_precision : (z3_context * z3_goal) -> int
  ...
  val Z3_mk_goal : (z3_context * int * int * int) -> z3_goal
  ...
  val Z3_get_error_code : (z3_context) -> int
  ...
  val Z3_model_eval : (z3_context * z3_model * z3_ast * int * MLton.Pointer.t) -> int
  ...
  val Z3_is_algebraic_number : (z3_context * z3_ast) -> int
  ...
  val Z3_is_quantifier_forall : (z3_context * z3_ast) -> int
  ...
  val Z3_is_numeral_ast : (z3_context * z3_ast) -> int
  val Z3_fixedpoint_get_statistics : (z3_context * z3_fixedpoint) -> z3_stats
  val Z3_solver_check : (z3_context * z3_solver) -> int
  val Z3_param_descrs_get_name : (z3_context * z3_param_descrs * int) -> z3_symbol
  val Z3_get_finite_domain_sort_size : (z3_context * z3_sort * MLton.Pointer.t) -> int
  ...
  val Z3_mk_bv2int : (z3_context * z3_ast * int) -> z3_ast
  ...
  val Z3_is_eq_func_decl : (z3_context * z3_func_decl * z3_func_decl) -> int
  ...
  val Z3_mk_bvmul_no_overflow : (z3_context * z3_ast * z3_ast * int) -> z3_ast
  val Z3_get_symbol_kind : (z3_context * z3_symbol) -> int
  val Z3_eval_func_decl : (z3_context * z3_model * z3_func_decl * z3_ast ref) -> int
  ...
  val Z3_global_param_get : (string * MLton.Pointer.t) -> int
  val Z3_get_sort_kind : (z3_context * z3_sort) -> int
  ...
  val Z3_get_numeral_int : (z3_context * z3_ast * MLton.Pointer.t) -> int
  ...
  val Z3_get_error_msg : (int) -> string
  ...
  val Z3_param_descrs_get_kind : (z3_context * z3_param_descrs * z3_symbol) -> int
  val Z3_get_model_constant : (z3_context * z3_model * int) -> z3_func_decl
  val Z3_tactic_skip : (z3_context) -> z3_tactic
  val Z3_params_set_bool : (z3_context * z3_params * z3_symbol * int) -> unit
  ...
  val Z3_get_decl_parameter_kind : (z3_context * z3_func_decl * int) -> int
  val Z3_model_get_sort_universe : (z3_context * z3_model * z3_sort) -> z3_ast_vector
  val Z3_get_numeral_small : (z3_context * z3_ast * MLton.Pointer.t * MLton.Pointer.t) -> int
  ...
  val Z3_get_numeral_uint : (z3_context * z3_ast * MLton.Pointer.t) -> int
  ...
  val Z3_eval_decl : (z3_context * z3_model * z3_func_decl * int * z3_ast vector * z3_ast ref) -> int
  ...
  val Z3_is_eq_ast : (z3_context * z3_ast * z3_ast) -> int
  val Z3_solver_to_string : (z3_context * z3_solver) -> string
  val Z3_set_logic : (z3_context * string) -> int
  val Z3_goal_is_decided_unsat : (z3_context * z3_goal) -> int
  ...
  val Z3_get_ast_kind : (z3_context * z3_ast) -> int
  ...
  val Z3_get_numeral_uint64 : (z3_context * z3_ast * MLton.Pointer.t) -> int
