...
struct
  ...
  let
    val dyn_Z3_param_descrs_to_string = _import * : DynLink.fptr -> (z3_context * z3_param_descrs) -> string;
  ...
  let
    val dyn_Z3_ast_map_contains = _import * : DynLink.fptr -> (z3_context * z3_ast_map * z3_ast) -> int;
  ...
  let
    val dyn_Z3_stats_is_double = _import * : DynLink.fptr -> (z3_context * z3_stats * int) -> int;
  ...
  let
    val dyn_Z3_append_log = _import * : DynLink.fptr -> (string) -> unit;
  ...
  let
    val dyn_Z3_mk_label = _import * : DynLink.fptr -> (z3_context * z3_symbol * int * z3_ast) -> z3_ast;
  ...
  let
    val dyn_Z3_get_param_value = _import * : DynLink.fptr -> (z3_context * string * MLton.Pointer.t) -> int;
  ...
  fun Z3_is_app (c,a) = 
  let
    val dyn_Z3_is_app = _import * : DynLink.fptr -> (z3_context * z3_ast) -> int;
  ...
  let
    val dyn_Z3_theory_is_decl = _import * : DynLink.fptr -> (z3_theory * z3_func_decl) -> int;
  ...
  let
    val dyn_Z3_mk_numeral = _import * : DynLink.fptr -> (z3_context * string * z3_sort) -> z3_ast;
  ...
  let
    val dyn_Z3_get_tactic_name = _import * : DynLink.fptr -> (z3_context * int) -> string;
  ...
  let
    val dyn_Z3_set_error = _import * : DynLink.fptr -> (z3_context * int) -> unit;
  ...
  let
    val dyn_Z3_get_symbol_string = _import * : DynLink.fptr -> (z3_context * z3_symbol) -> string;
  ...
  let
    val dyn_Z3_get_numeral_uint64 = _import * : DynLink.fptr -> (z3_context * z3_ast * MLton.Pointer.t) -> int;
  ...
  let
    val dyn_Z3_goal_is_decided_sat = _import * : DynLink.fptr -> (z3_context * z3_goal) -> int;
  ...
  let
    val dyn_Z3_theory_enable_axiom_simplification = _import * : DynLink.fptr -> (z3_theory * int) -> unit;
  ...
  let
    val dyn_Z3_get_ast_kind = _import * : DynLink.fptr -> (z3_context * z3_ast) -> int;
  ...
  let
    val dyn_Z3_global_param_set = _import * : DynLink.fptr -> (string * string) -> unit;
  ...
  let
    val dyn_Z3_goal_is_decided_unsat = _import * : DynLink.fptr -> (z3_context * z3_goal) -> int;
  ...
  let
    val dyn_Z3_set_logic = _import * : DynLink.fptr -> (z3_context * string) -> int;
  ...
  let
    val dyn_Z3_solver_to_string = _import * : DynLink.fptr -> (z3_context * z3_solver) -> string;
  ...
  let
    val dyn_Z3_is_eq_ast = _import * : DynLink.fptr -> (z3_context * z3_ast * z3_ast) -> int;
  ...
  let
    val dyn_Z3_get_bool_value = _import * : DynLink.fptr -> (z3_context * z3_ast) -> int;
  ...
  let
    val dyn_Z3_context_to_string = _import * : DynLink.fptr -> (z3_context) -> string;
  ...
  let
    val dyn_Z3_get_numeral_uint = _import * : DynLink.fptr -> (z3_context * z3_ast * MLton.Pointer.t) -> int;
  ...
  let
    val dyn_Z3_mk_probe = _import * : DynLink.fptr -> (z3_context * string) -> z3_probe;
  ...
  let
    val dyn_Z3_get_numeral_small = _import * : DynLink.fptr -> (z3_context * z3_ast * MLton.Pointer.t * MLton.Pointer.t) -> int;
  ...
  let
    val dyn_Z3_get_decl_parameter_kind = _import * : DynLink.fptr -> (z3_context * z3_func_decl * int) -> int;
  ...
  let
    val dyn_Z3_params_set_bool = _import * : DynLink.fptr -> (z3_context * z3_params * z3_symbol * int) -> unit;
  ...
  let
    val dyn_Z3_param_descrs_get_kind = _import * : DynLink.fptr -> (z3_context * z3_param_descrs * z3_symbol) -> int;
  ...
  let
    val dyn_Z3_set_ast_print_mode = _import * : DynLink.fptr -> (z3_context * int) -> unit;
  ...
  let
    val dyn_Z3_get_error_msg = _import * : DynLink.fptr -> (int) -> string;
  ...
  let
    val dyn_Z3_fixedpoint_to_string = _import * : DynLink.fptr -> (z3_context * z3_fixedpoint * int * MLton.Pointer.t) -> string;
  ...
  let
    val dyn_Z3_get_numeral_int = _import * : DynLink.fptr -> (z3_context * z3_ast * MLton.Pointer.t) -> int;
  ...
  let
    val dyn_Z3_is_as_array = _import * : DynLink.fptr -> (z3_context * z3_ast) -> int;
  ...
  let
    val dyn_Z3_stats_to_string = _import * : DynLink.fptr -> (z3_context * z3_stats) -> string;
  ...
  let
    val dyn_Z3_fixedpoint_query = _import * : DynLink.fptr -> (z3_context * z3_fixedpoint * z3_ast) -> int;
  ...
  let
    val dyn_Z3_is_eq_sort = _import * : DynLink.fptr -> (z3_context * z3_sort * z3_sort) -> int;
  ...
  let
    val dyn_Z3_fixedpoint_from_file = _import * : DynLink.fptr -> (z3_context * z3_fixedpoint * string) -> z3_ast_vector;
  ...
  let
    val dyn_Z3_probe_apply = _import * : DynLink.fptr -> (z3_context * z3_probe * z3_goal) -> real;
  ...
  let
    val dyn_Z3_pattern_to_string = _import * : DynLink.fptr -> (z3_context * z3_pattern) -> string;
  ...
  let
    val dyn_Z3_tactic_get_descr = _import * : DynLink.fptr -> (z3_context * string) -> string;
  ...
  let
    val dyn_Z3_ast_map_to_string = _import * : DynLink.fptr -> (z3_context * z3_ast_map) -> string;
  ...
  let
    val dyn_Z3_stats_is_uint = _import * : DynLink.fptr -> (z3_context * z3_stats * int) -> int;
  ...
  let
    val dyn_Z3_toggle_warning_messages = _import * : DynLink.fptr -> (int) -> unit;
  ...
  let
    val dyn_Z3_update_param_value = _import * : DynLink.fptr -> (z3_context * string * string) -> unit;
  ...
  let
    val dyn_Z3_fixedpoint_get_help = _import * : DynLink.fptr -> (z3_context * z3_fixedpoint) -> string;
  ...
  let
    val dyn_Z3_mk_fresh_const = _import * : DynLink.fptr -> (z3_context * string * z3_sort) -> z3_ast;
  ...
  fun Z3_reset_memory () = 
  let
    val dyn_Z3_reset_memory = _import * : DynLink.fptr -> unit -> unit;
  ...
  let
    val dyn_Z3_stats_get_key = _import * : DynLink.fptr -> (z3_context * z3_stats * int) -> string;
  ...
  let
    val dyn_Z3_get_sort_kind = _import * : DynLink.fptr -> (z3_context * z3_sort) -> int;
  ...
  let
    val dyn_Z3_global_param_get = _import * : DynLink.fptr -> (string * MLton.Pointer.t) -> int;
  ...
  let
    val dyn_Z3_ast_vector_to_string = _import * : DynLink.fptr -> (z3_context * z3_ast_vector) -> string;
  ...
  let
    val dyn_Z3_get_symbol_kind = _import * : DynLink.fptr -> (z3_context * z3_symbol) -> int;
  ...
  let
    val dyn_Z3_mk_bvmul_no_overflow = _import * : DynLink.fptr -> (z3_context * z3_ast * z3_ast * int) -> z3_ast;
  ...
  let
    val dyn_Z3_disable_trace = _import * : DynLink.fptr -> (string) -> unit;
  ...
  let
    val dyn_Z3_get_decl_double_parameter = _import * : DynLink.fptr -> (z3_context * z3_func_decl * int) -> real;
  ...
  let
    val dyn_Z3_params_set_double = _import * : DynLink.fptr -> (z3_context * z3_params * z3_symbol * real) -> unit;
  ...
  let
    val dyn_Z3_get_numeral_rational_int64 = _import * : DynLink.fptr -> (z3_context * z3_ast * MLton.Pointer.t * MLton.Pointer.t) -> int;
  ...
  let
    val dyn_Z3_mk_bvsub_no_underflow = _import * : DynLink.fptr -> (z3_context * z3_ast * z3_ast * int) -> z3_ast;
  ...
  let
    val dyn_Z3_is_eq_func_decl = _import * : DynLink.fptr -> (z3_context * z3_func_decl * z3_func_decl) -> int;
  ...
  let
    val dyn_Z3_mk_bv2int = _import * : DynLink.fptr -> (z3_context * z3_ast * int) -> z3_ast;
  ...
  let
    val dyn_Z3_get_numeral_string = _import * : DynLink.fptr -> (z3_context * z3_ast) -> string;
  ...
  let
    val dyn_Z3_is_well_sorted = _import * : DynLink.fptr -> (z3_context * z3_ast) -> int;
  ...
  let
    val dyn_Z3_is_array_value = _import * : DynLink.fptr -> (z3_context * z3_model * z3_ast * MLton.Pointer.t) -> int;
  ...
  let
    val dyn_Z3_get_search_failure = _import * : DynLink.fptr -> (z3_context) -> int;
  ...
  let
    val dyn_Z3_get_finite_domain_sort_size = _import * : DynLink.fptr -> (z3_context * z3_sort * MLton.Pointer.t) -> int;
  ...
  let
    val dyn_Z3_solver_check = _import * : DynLink.fptr -> (z3_context * z3_solver) -> int;
  ...
  let
    val dyn_Z3_is_numeral_ast = _import * : DynLink.fptr -> (z3_context * z3_ast) -> int;
  ...
  let
    val dyn_Z3_mk_tactic = _import * : DynLink.fptr -> (z3_context * string) -> z3_tactic;
  ...
  let
    val dyn_Z3_is_quantifier_forall = _import * : DynLink.fptr -> (z3_context * z3_ast) -> int;
  ...
  let
    val dyn_Z3_goal_inconsistent = _import * : DynLink.fptr -> (z3_context * z3_goal) -> int;
  ...
  let
    val dyn_Z3_enable_trace = _import * : DynLink.fptr -> (string) -> unit;
  ...
  let
    val dyn_Z3_model_to_string = _import * : DynLink.fptr -> (z3_context * z3_model) -> string;
  ...
  let
    val dyn_Z3_probe_const = _import * : DynLink.fptr -> (z3_context * real) -> z3_probe;
  ...
  let
    val dyn_Z3_stats_get_double_value = _import * : DynLink.fptr -> (z3_context * z3_stats * int) -> real;
  ...
  let
    val dyn_Z3_set_param_value = _import * : DynLink.fptr -> (z3_config * string * string) -> unit;
  ...
  fun Z3_check (c) = 
  let
    val dyn_Z3_check = _import * : DynLink.fptr -> (z3_context) -> int;
  ...
  let
    val dyn_Z3_is_algebraic_number = _import * : DynLink.fptr -> (z3_context * z3_ast) -> int;
  ...
  let
    val dyn_Z3_model_eval = _import * : DynLink.fptr -> (z3_context * z3_model * z3_ast * int * MLton.Pointer.t) -> int;
  ...
  let
    val dyn_Z3_probe_get_descr = _import * : DynLink.fptr -> (z3_context * string) -> string;
  ...
  let
    val dyn_Z3_get_decl_kind = _import * : DynLink.fptr -> (z3_context * z3_func_decl) -> int;
  ...
  let
    val dyn_Z3_fixedpoint_from_string = _import * : DynLink.fptr -> (z3_context * z3_fixedpoint * string) -> z3_ast_vector;
  ...
  let
    val dyn_Z3_get_probe_name = _import * : DynLink.fptr -> (z3_context * int) -> string;
  ...
  let
    val dyn_Z3_theory_is_value = _import * : DynLink.fptr -> (z3_theory * z3_ast) -> int;
  ...
  let
    val dyn_Z3_get_numeral_decimal_string = _import * : DynLink.fptr -> (z3_context * z3_ast * int) -> string;
  ...
  let
    val dyn_Z3_get_error_code = _import * : DynLink.fptr -> (z3_context) -> int;
  ...
  let
    val dyn_Z3_params_to_string = _import * : DynLink.fptr -> (z3_context * z3_params) -> string;
  ...
  let
    val dyn_Z3_mk_string_symbol = _import * : DynLink.fptr -> (z3_context * string) -> z3_symbol;
  ...
  let
    val dyn_Z3_get_smtlib_error = _import * : DynLink.fptr -> (z3_context) -> string;
  ...
  let
    val dyn_Z3_goal_to_string = _import * : DynLink.fptr -> (z3_context * z3_goal) -> string;
  ...
  let
    val dyn_Z3_get_numeral_int64 = _import * : DynLink.fptr -> (z3_context * z3_ast * MLton.Pointer.t) -> int;
  ...
  let
    val dyn_Z3_open_log = _import * : DynLink.fptr -> (string) -> int;
  ...
  let
    val dyn_Z3_tactic_get_help = _import * : DynLink.fptr -> (z3_context * z3_tactic) -> string;
  ...
  let
    val dyn_Z3_solver_get_help = _import * : DynLink.fptr -> (z3_context * z3_solver) -> string;
  ...
  let
    val dyn_Z3_apply_result_to_string = _import * : DynLink.fptr -> (z3_context * z3_apply_result) -> string;
  ...
  let
    val dyn_Z3_mk_goal = _import * : DynLink.fptr -> (z3_context * int * int * int) -> z3_goal;
  ...
  let
    val dyn_Z3_mk_bvadd_no_overflow = _import * : DynLink.fptr -> (z3_context * z3_ast * z3_ast * int) -> z3_ast;
  ...
  let
    val dyn_Z3_solver_get_reason_unknown = _import * : DynLink.fptr -> (z3_context * z3_solver) -> string;
  ...
  let
    val dyn_Z3_get_decl_rational_parameter = _import * : DynLink.fptr -> (z3_context * z3_func_decl * int) -> string;
  ...
  let
    val dyn_Z3_fixedpoint_get_reason_unknown = _import * : DynLink.fptr -> (z3_context * z3_fixedpoint) -> string;
  ...
  let
    val dyn_Z3_simplify_get_help = _import * : DynLink.fptr -> (z3_context) -> string;
  ...
  let
    val dyn_Z3_goal_precision = _import * : DynLink.fptr -> (z3_context * z3_goal) -> int;
  ...
  let
    val dyn_Z3_mk_theory = _import * : DynLink.fptr -> (z3_context * string * z3_theory_data) -> z3_theory;
  ...
  let
    val dyn_Z3_get_error_msg_ex = _import * : DynLink.fptr -> (z3_context * int) -> string;
  ...
  let
    val dyn_Z3_func_decl_to_string = _import * : DynLink.fptr -> (z3_context * z3_func_decl) -> string;
  ...
  let
    val dyn_Z3_statistics_to_string = _import * : DynLink.fptr -> (z3_context) -> string;
